...
const NavComponent11 = () => {
  ...
  const weightageCalculator = () => {
    if (category === "workshop attended") {
      return 10;
    }
    if (category === "registered for startup") {
      return 50;
    }
    if (category === "released product") {
      return 100;
    }
  };
        ...
        <form className="add-newdata-form" onSubmit={handleUpload}>
          <section className="form-group">
            ...
            >
              ...
              <option value="workshop attended">Workshop attended</option>
              <option value="registered for startup">
                Registered for startups
              </option>
              <option value="released product">Released product</option>
            </select>
          </section>
          <section className="form-group">
            <label htmlFor="category" className="form-label">
