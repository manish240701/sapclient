...
const NavComponent9 = () => {
  ...
  const weightageCalculator = () => {
    ...
    if (category === "qualified in gate/ cat etc.") {
      return 30;
    }
    if (category === "good national ranking in gate/ cat etc.") {
      return 100;
    }
    if (category === "cleared govt exam") {
      return 100;
    }
  };
        ...
        <form className="add-newdata-form" onSubmit={handleUpload}>
          <section className="form-group">
            ...
            >
              ...
              <option value="qualified in gate/ cat etc.">
                Qualified in GATE/ CAT etc.
              </option>
              <option value="good national ranking in gate/ cat etc.">
                Good National ranking in GATE/CAT
              </option>
              <option value="cleared govt exam">Cleared Govt Exam</option>
            </select>
          </section>
          <section className="form-group">
            <label htmlFor="category" className="form-label">
