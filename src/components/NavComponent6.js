...
const NavComponent6 = () => {
  ...
  const weightageCalculator = () => {
    if (category === "chairman/ secretary/ treasurer etc.") {
      return 30;
    }
    if (category === "joint secretary/vice chairman etc.") {
      return 20;
    }
    if (category === "ec member") {
      return 10;
    }
    if (
      category ===
      "class representative/ placement coordinator/ cell coordinator/ iv or ipt coordinator"
    ) {
      return 10;
    }
  };
        ...
        <form className="add-newdata-form" onSubmit={handleUpload}>
          <section className="form-group">
            ...
            >
              ...
              <option value="chairman/ secretary/ treasurer etc.">
                Chairman/ Secretary/ Treasurer etc.
              </option>
              <option value="joint secretary/vice chairman etc.">
                Joint Secretary/ Vice Chairman etc.
              </option>
              <option value="ec member">EC Member</option>
              <option value="class representative/ placement coordinator/ cell coordinator/ iv or ipt coordinator">
                Class Representative/ Placement Coordinator/ Cell Coordinator/
                IV or IPT Coordinator
              </option>
            </select>
          </section>
          <section className="form-group">
