...
const NavComponent7 = () => {
  ...
  const weightageCalculator = () => {
    if (category === "value added course (non credit course)") {
      return 5;
    }

    if (
      category ===
        "physical (industry collaboration)/ online courses like nptel etc." &&
      courseCredits === "one"
    ) {
      return 10;
    }
  ...
  useEffect(() => {
    if (category === "value added course (non credit course)" && file) {
      setAllFilled(true);
    }
        ...
        <form className="add-newdata-form" onSubmit={handleUpload}>
          <section className="form-group">
            ...
            >
              ...
              <option value="value added course (non credit course)">
                Value Added Course (Non credit Course)
              </option>
              <option value="physical (industry collaboration)/ online courses like nptel etc.">
                Physical (industry collaboration)/online courses like nptel etc.
              </option>
            </select>
          </section>
          {category ===
            ...
            <section className="form-group">
              ...
              >
                ...
                <option value="one">One credit course</option>
                <option value="two">Two credit courses</option>
                <option value="more than two">
                  More than two credit courses
                </option>
              </select>
            </section>
          )}
